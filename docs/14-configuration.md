...
| [Toolbar](07-profiler-toolbar.md) | `STOPWATCH_INJECT`, `STOPWATCH_INJECT_AUTO_REGISTER`, `STOPWATCH_INJECT_ENVIRONMENTS`, `STOPWATCH_INJECT_POSITION`, `STOPWATCH_INJECT_SLOW_REQUEST_MS` |
